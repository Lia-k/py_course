...
from lesson19.pages.dashboard_page.dashboard_locator_collection import \
    DashboardLocatorsCollection
from lesson19.pages.product_list_page import ProductListPage
from lesson19.core.locator import Locator
from lesson19.core.page_singleton import singleton
from lesson19.pages.base_page import BasePage
