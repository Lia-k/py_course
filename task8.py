...
john = {'full_name': john_name, 'age': john_age, 'salary': john_salary, 'gender': john_gender,
        'friends': john_friends, 'coordinates': coordinates1}
marta = {'full_name': marta_name, 'age': marta_age, 'salary': marta_salary, 'gender': marta_gender,
         'friends': marta_friends, 'coordinates': coordinates1}
...
john_friends1 = {'full_name': 'Ted', 'age': 25, 'salary': 1325.2, 'gender': True, 'friends': ['Jes', 'Tina', 'Mark'],
                 'coordinates': (12365.556, 1235.34)}
john_friends2 = {'full_name': 'Mark', 'age': 28, 'salary': 1562.2, 'gender': True, 'friends': ['Jes', 'Tina', 'Ted'],
                 'coordinates': (5684.556, 46485.89)}
john['friends'] = [john_friends1, john_friends2]

marta_friends1 = {'full_name': 'Jennifer', 'age': 20, 'salary': 956.2, 'gender': False, 'friends': ['Tom', 'Mina', 'Henk'],
                  'coordinates': (456841.556, 87986.34)}
marta_friends2 = {'full_name': 'Chris', 'age': 23, 'salary': 0, 'gender': True, 'friends': ['Jes', 'Paul', 'Peter'],
